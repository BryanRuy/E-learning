...
export const GET_USER_DATA = (userId) =>
  `${BASE_URL}/api/v1/students/${userId}`;
...
export const GET_TEST_ATTEMPT_DETAILS = (id) =>
  `${BASE_URL}/api/v1/tests/${id}/attempts`;
...
export const GET_ASSIGNMENT_ATTEMPT = (id) =>
  `${BASE_URL}/api/v1/assignments-attempts/${id}`;
export const GET_ASSIGNMENT = (id) => `${BASE_URL}/api/v1/assignments/${id}`;

//Profile
export const UPDATE_PROFILE_DATA = (id) =>
  `${BASE_URL}/api/v1/students/${id}/profile`;
export const UPLOAD_PROFILE_PICTURE = (id) =>
  `${BASE_URL}/api/v1/students/${id}/profile-picture`;
export const UPDATE_PASSWORD = (id) =>
  `${BASE_URL}/api/v1/students/${id}/password`;

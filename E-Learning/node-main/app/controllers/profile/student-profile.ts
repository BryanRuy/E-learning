...
export async function UpdateBasicInfo(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        let user = await ProfileUtil.UpdateBasicInfo(params, student._userId!, student.roleId!)
...
export async function UpdatePassword(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const user = await ProfileUtil.UpdatePassword(newPassword, currentPassword, student, student.roleId!)
...
export async function UpdateProfilePicture(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const user = await ProfileUtil.UpdateUserProfilePicture(`/profile-pictures/${fileName}`, student._userId, student.roleId!)

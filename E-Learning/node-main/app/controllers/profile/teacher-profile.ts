...
export async function UpdateBasicInfo(
  ...
  try {
    ...
    if((role == 'super-admin' || role == 'admin' )&& storage){ params.storage = storage * 1024 * 1024 }
    ...
    if (role == "teacher") delete user.teacher?.students;
